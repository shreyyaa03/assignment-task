<x-layout>
   <div class="container text-center my-5">
    <h2 class="disable">The Need for Task Management</h2>
   ...
   <div class="container d-flex text-center flex-wrap justify-content-around align-items-center py-5">
    <form action="">
        @csrf
        <a href="/login"><button type="button" class="btn btn-dark">LOGIN</button></a>
        <a href="/signup"><button type="button" class="btn btn-dark">SINGUP</button></a>
    </form>
   </div>
